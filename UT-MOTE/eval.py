...
if __name__ == '__main__':
    ...
    for seq_num in seq_nums:
        ...
        evaluator = Evaluator('/work/Institution/author/data/MOT15/train', seq_num)
        vote_index, vote_metrics = evaluator.calculate_vote_metric()

        print("VOTE Index:", vote_index)
        print("VOTE Metrics:", vote_metrics)
        with open("motr_exp_mot17/eval_vote_log.txt", 'a') as f:
    ...
    max_aod = max(len(evaluator.gt_frame_dict) for evaluator in [Evaluator('/work/Institution/author/data/MOT15/train', seq_num) for seq_num in seq_nums])
    ...
    print(strsummary)
    with open("motr_exp_mot17/eval_log.txt", 'a') as f:
