...
# logging.basicConfig(filename='training_rotr.log', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message.address)s')
...
def get_args_parser():
    ...
    parser.add_argument('--img_width', default=1536, type=int, help='Image width for training')
    parser.add_argument('--img_height', default=800, type=int, help='Image height for training')
    parser.add_argument('--unitrack_iou_threshold', default=0.5, type=float, help='IoU threshold for unitrack loss')
    ...
    parser.add_argument('--use_unitrack_loss', action='store_true', help='Use unitrack loss for tracking')
    parser.add_argument('--unitrack_loss_coef', default=1, type=float, help='Coefficient for unitrack loss')
    ...
    parser.add_argument('--mot_path', default='/work/aclab/bishoy/post_data/', type=str)
