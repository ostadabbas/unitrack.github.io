...
def _check_size_scale_factor(dim, size, scale_factor):
    ...
    if scale_factor is not None and not isinstance(scale_factor, (int, float)):
        raise ValueError(
            "scale_factor must be a number or a tuple of numbers"
        )
...
def interpolate(input: Tensor, size: Optional[List[int]] = None, scale_factor: Optional[float] = None,
                mode: str = "nearest", align_corners: Optional[bool] = None) -> Tensor:
    """
