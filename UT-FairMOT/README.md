...
* (2021.06.01) A [nice re-implementation](https://github.com/PaddlePaddle/PaddleDetection/tree/release/2.1/configs/mot) by du [PaddleDetection](https://github.com/PaddlePaddle/PaddleDetection)!
...
```
to generate the labels of 2DMOT15 and MOT20. The seqinfo.ini files of 2DMOT15 can be downloaded here [[Google]](https://drive.google.com/open?id=1kJYySZy7wyETH4fKMzgJrYUrTfxKlN1w), [[du],code:8o0w](https://pan.du.com/s/1zb5tBW7-YTzWOXpd9IzS0g).
...
```
The MOT20 model 'mot20_fairmot.pth' can be downloaded here: [[Google]](https://drive.google.com/file/d/1HVzDTrYSSZiVqExqG9rou3zZXX1-GGQn/view?usp=sharing) [[du, code:jmce]](https://pan.du.com/s/1bpMtu972ZszsBx4TzIT_CA).
...
```
The pretrained model of yolov5s on the COCO dataset can be downloaded here:  [[Google]](https://drive.google.com/file/d/1Ur3_pa9r3KRY-5qM2cdFhFJ5exghRJvh/view?usp=sharing) [[du, code:wh9h]](https://pan.du.com/s/1JHjN_l1nkMnRHRF5TcHYXg).

The model of the light version 'fairmot_yolov5s' can be downloaded here:  [[Google]](https://drive.google.com/file/d/1MEvsRPyoAqYSCdKaS5Ofrl7ZfKbBZ1Jb/view?usp=sharing) [[du, code:2y3a]](https://pan.du.com/s/1dyBEeiGpRfZhqae0c264rg).
