...
if __name__ == '__main__':
    data_val = 'USER_HOME/dataset/crowdhuman/images/val'
    label_val = 'USER_HOME/dataset/crowdhuman/labels_with_ids/val'
    ann_val = 'USER_HOME/dataset/crowdhuman/annotation_val.odgt'
    data_train = 'USER_HOME/dataset/crowdhuman/images/train'
    label_train = 'USER_HOME/dataset/crowdhuman/labels_with_ids/train'
    ann_train = 'USER_HOME/dataset/crowdhuman/annotation_train.odgt'
